...
namespace JokerB\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'JokerB\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'JokerB\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'JokerB\Theme\App\Setup\modify_excerpt_length');
